...
PKG_URL=""
PKG_DEPENDS_TARGET="toolchain libc:init busybox:init util-linux:init e2fsprogs:init splash:init plymouth-lite:init dosfstools:init exfat:init fakeroot:host spleen-font:init"
PKG_SECTION="virtual"
